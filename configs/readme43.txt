...
Legal stuff
===========
FrozenSand accepts no responsibility for any damage or injuries
...
release of Urban Terror should first contact FrozenSand at 
...
- Added instagib to the server_example.cfg #342
...
> See the full release notes here: http://www.urbanterror.info/support/227-release-notes/


==============================
BETA 4.2 - August 3rd, 2012
==============================
...
- Added ut4_company in the Urban Terror package as a standalone pk3.
...
- New FrozenSand introduction graphics
...
- g_allowvote values changed. Check http://www.urbanterror.info/docs/texts/123/#2.3
...
teamname
    Captains can use this command to set team names; syntax: teamname <name>
...
========================================
Former/Inactive FrozenSand / Silicon Ice Development Members:
========================================
